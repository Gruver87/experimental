...
def test_empty_metrics_cover_known_keys() -> None:
    ...
    assert "libp2p_bootstrap_removed" in empty
    assert "libp2p_bootstrap_cleared" in empty
    ...
    assert "libp2p_last_observed_addr" in empty
    assert "libp2p_observed_addr_updates" in empty
    assert "libp2p_observed_addr_confirmed" in empty
    assert "libp2p_observed_addr_cleared" in empty
    assert "libp2p_confirm_observed_addr" in empty
    ...
    assert "libp2p_peerstore_cleared" in empty
    ...
    assert "libp2p_external_addr_loaded" in empty
    assert "libp2p_external_addr_persisted" in empty
    assert "libp2p_max_advertised_external" in empty
    assert "libp2p_listen_derived_externals" in empty
    assert "libp2p_aux_advertised_externals" in empty
    assert "libp2p_advertised_externals_used" in empty
    assert "libp2p_external_addr_limit_refused" in empty
    ...
    assert "libp2p_identify_candidate_omitted" in empty
    assert "libp2p_mdns_listen_addr_omitted" in empty
    assert "libp2p_mdns_advertised_listen" in empty
    assert "libp2p_kad_listen_addr_omitted" in empty
    assert "libp2p_kad_advertised_listen" in empty
    assert "libp2p_autonat_listen_addr_omitted" in empty
    assert "libp2p_autonat_advertised_listen" in empty
    assert "libp2p_upnp_listen_addr_omitted" in empty
    assert "libp2p_upnp_advertised_listen" in empty
    assert "libp2p_dcutr_candidate_omitted" in empty
    assert "libp2p_dcutr_advertised_candidates" in empty
