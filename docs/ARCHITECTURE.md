...
flowchart TB
  ...
  subgraph net ["Network plane"]
    ...
    LP["rust-libp2p · ADR 0019 A-CK · FEATURE_LIBP2P opt-in"]
  end
...
| [0019](adr/0019-rust-libp2p-industrial.md) | rust-libp2p | Slices **A–CK** (phase 88) behind Cargo `libp2p`; advertised unique cap 20 |
