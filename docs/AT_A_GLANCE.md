...
- **Execution order (what when):** [EXECUTION_ORDER.md](EXECUTION_ORDER.md) — Phases 1–4 closed; Phase 5 re-verified; wire satoshi + persist fail-closed landed; remaining polish P0: native f64-unwrap ([INDUSTRIAL_MAX_SCAN_2026-09-20.md](INDUSTRIAL_MAX_SCAN_2026-09-20.md))
