...
- **Execution order (what when):** [EXECUTION_ORDER.md](EXECUTION_ORDER.md) — Phases 1–4 closed; Phase 5 re-verified; wire satoshi + persist fail-closed + native f64 hygiene landed; remaining: Phase 6 / HIGH honesty items ([INDUSTRIAL_MAX_SCAN_2026-09-20.md](INDUSTRIAL_MAX_SCAN_2026-09-20.md))
