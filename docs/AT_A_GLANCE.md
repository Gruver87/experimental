...
| ADR 0019 | Slices **A–CY** · phase **102** |
| Hard gate | **114** steps with `--rebuild` (2026-08-15, operator-local) |
...
|--------------|-------------|
| rust-libp2p swarm A–CY behind Cargo `libp2p` | Prod mesh cutover |
...
| Long-Range / EVM precompile labs | Firm audit PDF |
