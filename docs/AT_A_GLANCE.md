...
| Self-check | `.\scripts\verify_global_rd_audit.ps1` (FullLaunch/Live) · `.\scripts\verify_pre_soak.ps1` · `.\scripts\verify_wave_e.ps1` · `.\scripts\verify_wave_f.ps1` · `.\scripts\verify_wave_g.ps1` · `.\scripts\verify_wave_h.ps1` · `.\scripts\verify_evm_depth_lab.ps1` · `.\scripts\verify_long_range_lab.ps1` · `.\scripts\verify_council_lab.ps1` · `.\scripts\verify_hard_all.ps1` · `python scripts/verify_experimental_rd.py` |
