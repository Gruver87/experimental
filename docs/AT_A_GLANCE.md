...
- **Execution order (what when):** [EXECUTION_ORDER.md](EXECUTION_ORDER.md) — Phases 1–4 closed; Phase 5 re-verified; wire/persist/native + HIGH + P0 + MED + verify_hard_all/pytest restore landed; next: mesh rebuild+probe on tip, ceremony dry-run, Phase 6 org / optional tip-safety soak ([INDUSTRIAL_MAX_SCAN_2026-09-20.md](INDUSTRIAL_MAX_SCAN_2026-09-20.md))
