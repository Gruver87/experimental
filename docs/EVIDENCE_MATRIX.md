...
| [`lr48fail1`](evidence/runs/lr48fail1/) | Long-Range lab 3-node mesh 48h | **48h FAIL** (`passed=false`, `hard_fails=0`, mesh_warn=28 non-transient, tip h4→~6782) | Tip growth OK; scorer FAIL on height deltas up to ~22. **Not PASS / not BLS / not prod / not mainnet** |
| [`lr2hintensify`](evidence/runs/lr2hintensify/) | Long-Range lab intensify 2h | **2h PASS** (`passed=true`, `hard_fails=0`, `mesh_warn=0`, tip ~6828→~7765) | BLOCK_TIME=5 + chaos bounce preflight after lr48fail1 fixes. **Not 48h / not B2 close / not BLS / not mainnet** |

### Lab evidence (not soak)

| Claim | Status | Artifact |
|-------|--------|----------|
| ADR 0017 Long-Range lab | **Lab mesh 2h PASS** [`lr2hmesh`](evidence/runs/lr2hmesh/); **lab 48h FAIL** [`lr48fail1`](evidence/runs/lr48fail1/); **intensify 2h PASS** [`lr2hintensify`](evidence/runs/lr2hintensify/) (preflight only) | 3-node compose + committee + outbound WS gossip. Prod mesh keeps `feature_long_range=false`. **not BLS / not prod arm / not mainnet Long-Range proof / not 48h PASS.** |
