...
| Area | Status | Notes |
|------|--------|-------|
| Transfer + fee burn | **Supported** | Native apply + satoshi domain. Nested CALL writeback `transfer_value` refuses `insufficient_writeback_value` (no clamp-to-zero mint) |
