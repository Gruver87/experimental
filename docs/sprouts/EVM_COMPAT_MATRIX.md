...
| Precompiles (ecrecover, sha256, …) | **Partial** | **0x01 ecrecover + 0x02 sha256 + 0x03 ripemd160 + 0x04 identity** via `execution/evm_precompiles.py`; modexp/bn254/blake2f still open |
