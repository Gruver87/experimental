...
| libp2p (rust industrial) | [ADR 0019](docs/adr/0019-rust-libp2p-industrial.md) Slices **A–CH** · `scripts/verify_adr0019_libp2p_hard.ps1` |
...
# ADR 0019 rust-libp2p hard gate (96 steps after Slice CH; 97 with `-Rebuild`)
