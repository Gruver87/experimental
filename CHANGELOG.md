...
- **CI green restore (2026-09-21):** `rustls` 0.23.45 (`RUSTSEC-2026-0285`); `cargo fmt` abs_native; quote YAML step name in `experimental-rd.yml`. Fund diligence card: [`docs/FUND_READINESS.md`](docs/FUND_READINESS.md). **Not** 48h soak.
