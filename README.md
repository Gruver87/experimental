...
| Track | Status | Entry |
|-------|--------|-------|
| **ADR 0019 rust-libp2p** | Slices **A–CP** (phase 93) behind Cargo `libp2p` | [ADR 0019](docs/adr/0019-rust-libp2p-industrial.md) · hard verify below |
...
### Experimental only (ADR 0019 hard — 104 steps, 105 with `--rebuild`)
...
Last surface update: **2026-08-15** — ADR 0019 through Slice **CP** (phase 93).
