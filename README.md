...
| Track | Status | Entry |
|-------|--------|-------|
| **ADR 0019 rust-libp2p** | Slices **A–CK** (phase 88) behind Cargo `libp2p` | [ADR 0019](docs/adr/0019-rust-libp2p-industrial.md) · hard verify below |
...
### Experimental only (ADR 0019 hard — 99 steps, 100 with `--rebuild`)
...
Last surface update: **2026-08-14** — ADR 0019 through Slice **CK** (phase 88).
