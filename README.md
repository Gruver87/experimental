...
| Track | Status | Entry |
|-------|--------|-------|
| **ADR 0019 rust-libp2p** | Slices **A–BU** (phase 72) behind Cargo `libp2p` | [ADR 0019](docs/adr/0019-rust-libp2p-industrial.md) · hard verify below |
...
### Experimental only (ADR 0019 hard — 83 steps, 84 with `--rebuild`)
