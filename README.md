...
| Track | Status | Entry |
|-------|--------|-------|
| **ADR 0019 rust-libp2p** | Slices **A–BN** (phase 65) behind Cargo `libp2p` | [ADR 0019](docs/adr/0019-rust-libp2p-industrial.md) · hard verify below |
...
### Experimental only (ADR 0019 hard — 76 steps)
...
Last surface update: **2026-08-13** — ADR 0019 through Slice **BN** · unified Hybrid+Experimental verify.
