...
| Track | Status | Entry |
|-------|--------|-------|
| **ADR 0019 rust-libp2p** | Slices **A–BL** (phase 63) behind Cargo `libp2p` | [ADR 0019](docs/adr/0019-rust-libp2p-industrial.md) · hard verify below |
...
### Experimental only (ADR 0019 hard — 74 steps)
...
Last surface update: **2026-08-10** — ADR 0019 through Slice **BL** · unified Hybrid+Experimental verify.
