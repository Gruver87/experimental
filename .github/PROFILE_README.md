...
| [**experimental**](https://github.com/Gruver87/experimental) | **R&D sandbox** · rust-libp2p **48h PASS** (`3c801b87`) · LR lab **48h PASS** (`lr48pass1`) · Phase 3 mesh **48h PASS** (`evm48pass1`) · next ADR 0021 | [AT_A_GLANCE](https://github.com/Gruver87/experimental/blob/main/docs/AT_A_GLANCE.md) · [EXECUTION_ORDER](https://github.com/Gruver87/experimental/blob/main/docs/EXECUTION_ORDER.md) |
